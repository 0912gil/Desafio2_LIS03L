...
class ProductosModel extends Model{
    ...
    public function get($id=''){
        ...
        if($id==''){
            ...
            $query="SELECT * FROM Productos P INNER JOIN Categoria C ON 
            P.id_categoria=C.id_categoria";
            return $this->get_query($query);
        }
        else{
            //retornar un producto por su llave primaria
            $query="SELECT * FROM Productos INNER JOIN Categoria C ON 
    ...
    public function create($producto=array()){
        extract($producto);
        $query="INSERT INTO Productos(id_producto,nombre,descripcion,imagen,id_categoria,precio,existencias,estado) 
    ...
    public function update($producto=array()){
        extract($producto);
        $query="UPDATE Productos SET id_producto=:id_producto,nombre=:nombre,descripcion=:descripcion,imagen=:imagen,
